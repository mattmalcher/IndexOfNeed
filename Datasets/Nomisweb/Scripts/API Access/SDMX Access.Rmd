...
ap<-'https://www.nomisweb.co.uk/api/v01/dataset' #Note - https can cause issues on windows (cURL issue?) but using http causes issues with the api functionality
...
Get List of output areas for a given geography type and
```{r}
dataset<-'NM_1_1'
qtype<-'geography'
geography<-'2092957697'
